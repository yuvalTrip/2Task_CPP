...
int main() {
  // Create two players with their names
   ...
   for (int i=0;i<5;i++) {
    ...
    cout <<"p1.stacksize():" <<p1.stacksize() << endl; //prints the amount of cards left. should be 21 but can be less if a draw was played
    cout << "p2.cardesTaken():"<<p2.cardesTaken() << endl; // prints the amount of cards this player has won.
